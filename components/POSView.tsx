...
import { Search, Plus, Minus, Trash2, Receipt, ChefHat, Save, Loader2, MessageSquare, ShoppingCart, ChevronDown, ChevronUp, X, CreditCard, Banknote, Smartphone } from 'lucide-react';
...
export const POSView: React.FC<POSViewProps> = ({
  ...
  useEffect(() => {
    if (!activeOrder) {
      ...
      // Fix: Sync delivery method if it was updated externally (e.g. by the Bill Modal)
  ...
  const handlePrintClick = () => {
    ...
    onPrintBill({ ...localOrder, deliveryMethod: 'Printed' }); // Optimistic update passed to printer
  ...
  // Components to reduce duplication between mobile/desktop views
