...
export const BillTemplate: React.FC<BillTemplateProps> = ({ order, settings, tableId, onClose, onUpdateDeliveryMethod }) => {
  ...
  const handleWhatsApp = () => {
    ...
    // Default to India (91) if 10 digits are provided
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 w-full md:w-auto">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="flex-1 flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-50 text-white px-4 py-2 rounded-lg font-bold shadow-md transition-all active:scale-95 text-sm whitespace-nowrap"
              >
              ...
              <button 
                onClick={handlePrint}
                className="flex-1 flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-50 text-white px-4 py-2 rounded-lg font-bold shadow-md transition-all active:scale-95 text-sm whitespace-nowrap"
              >
                <Printer size={18} />
                <span>Print</span>
              </button>
